...
public class Bootcamp {
    ...
    private final LocalDate dataFinal = dataInicial.plusDays(45); // Adiciona prazo final a partir da data do inicio
    private Set<Dev> devsIncritos = new HashSet<>(); //Hashset pois a ordem que eles sao adicionados é irrelevante
